...
public class PacketProtocol {
    ...
    public static final String READY_STATUS = "READY_STATUS"; // To send/receive ready updates
    public static final String START_GAME = "START_GAME";     // Command from server to open Maze
}